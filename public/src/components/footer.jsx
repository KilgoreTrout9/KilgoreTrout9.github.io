        ...
        <div class="row">
          ...
          <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
            ...
            <div class="contact-box__info">
              <a href="#" class="contact-box__info--title">my phone number</a>
              <p class="contact-box__info--subtitle">availability</p>
            </div>
          </div>
          {/* Content for email */}
          <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
            ...
            <div class="contact-box__info">
              <a href="#" class="contact-box__info--title">my company email</a>
              <p class="contact-box__info--subtitle">what its for</p>
            </div>
          </div>
          ...
          <div class="col-md-4 col-lg-4 contact-box pt-1 d-md-block d-lg-flex d-flex">
            ...
            <div class="contact-box__info">
              <a href="#" class="contact-box__info--title">where am I now</a>
              <p class="contact-box__info--subtitle">specific details</p>
            </div>
          </div>
        </div>
      </div>
      <div class="footer-sm">
        <div class="container">
          <div class="row py-4 text-center text-white">
            <div class="col-lg-5 col-md-6 mg-4 mb-md-0">
          ...
          <div class="row text-center text-white">
            <div class="col-12">
              <div class="footer-bottom__copyright">
                &copy; Copyright 2021 <a href="#">Multi-Purpose Company</a> | Created by <a href="#">KilgoreTrout</a>
              </div>
            </div>
          </div>
        </div>
